...
pub fn generate_passphrase(word_count: usize, separator: &str) -> Result<String> {
    ...
    const WORDS: &[&str] = &[
        ...
        "airport", "aisle", "alarm", "album", "alcohol", "alert", "alien", "allow",
        ...
        "atom", "attack", "attend", "attract", "auction", "audit", "august", "aunt",
        ...
        "basket", "battle", "beach", "beauty", "become", "bedroom", "before", "begin",
        "believe", "below", "bench", "benefit", "best", "better", "between", "beyond",
        ...
        "bring", "broken", "bronze", "brother", "brown", "brush", "bubble", "bucket",
        "budget", "buffalo", "build", "bulb", "bulk", "bullet", "bundle", "burden",
        "burger", "burst", "butter", "cabin", "cable", "cactus", "cage", "camera",
        "camp", "canal", "cancel", "candy", "cannon", "canyon", "capable", "capital",
        "captain", "carbon", "career", "cargo", "carpet", "carry", "cart", "castle",
        "casual", "catalog", "catch", "category", "cattle", "ceiling", "celery",
        "cement", "census", "century", "cereal", "certain", "chair", "chalk", "champion",
        "change", "chaos", "chapter", "charge", "charity", "cheap", "cheese", "cherry",
        "chicken", "chief", "child", "choice", "chunk", "churn", "circle", "citizen",
        "city", "civil", "claim", "clap", "clarify", "claw", "clay", "clean", "clerk",
        "clever", "click", "client", "cliff", "climb", "clinic", "clip", "clock",
        "close", "cloth", "cloud", "clown", "club", "cluster", "coach", "coast",
        "coconut", "code", "coffee", "coin", "collect", "color", "column", "combine",
        "comfort", "comic", "common", "company", "concert", "conduct", "confirm",
        "congress", "connect", "consider", "control", "convince", "cookie", "copper",
        "coral", "corner", "correct", "couch", "country", "couple", "course", "cousin",
        ...
        "crumble", "crush", "crystal", "cube", "culture", "cupboard", "curious",
        "current", "curtain", "curve", "cushion", "custom", "cycle", "damage", "dance",
        "danger", "daring", "dash", "daughter", "dawn", "decade", "decide", "decline",
        "decorate", "decrease", "deep", "defense", "define", "delay", "deliver",
        ...
        "direct", "dirt", "disagree", "discover", "disease", "dish", "dismiss", "display",
        "distance", "divert", "divide", "divorce", "dizzy", "doctor", "document", "domain",
        "donate", "donkey", "door", "dose", "double", "dove", "draft", "dragon", "drama",
        "drastic", "draw", "dream", "dress", "drift", "drill", "drink", "drip", "drive",
        "drop", "drum", "dry", "duck", "dumb", "dune", "during", "dust", "dutch", "duty",
        "dwarf", "dynamic", "eager", "eagle", "early", "earth", "easily", "east", "easy",
        "echo", "ecology", "economy", "edge", "edit", "educate", "effort", "eight", "either",
